...
class FilmKontroler{
    ...
    //Azuriranje filmova
    public  function azuriraj_film($film_id)
    {
        ...
        $query = $this->pdo->prepare('UPDATE biza_filmova.film SET film.naslov = ?, film.godina = ?, film.zanr_id = ?  WHERE film.film_id = ?');
    ...
    {
        $sql = "DELETE FROM baza_filmova.film WHERE film_id=?";
